              ...
              <div class="list-group activity-list">
                ...
                <div class="list-group-item flex-column align-items-start">
                  <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1 text-uppercase">{{ $act->name_kegiatan }}</h5>
          ...
          <div class="col-12 mt-3">
            <form name="change_profile_form" method="POST" action="{{ url('/profile/update/data') }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-12">
                  <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama" value="{{ auth()->user()->name }}">
                </div>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-12 mt-3 text-center">
            <p class="nama-akun">{{ auth()->user()->name }}</p>
            <p class="posisi-akun">{{ auth()->user()->level }}</p>
          </div>
          ...
          {{-- <div class="col-12">
            ...
            <div class="text-group mt-2">
              <div class="d-flex justify-content-between">
                <p class="nama-aktivitas">{{ $act->name_kegiatan }}</p>
